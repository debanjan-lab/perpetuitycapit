        ...
        <View style={{ padding: 15 }}>
          <View style={{ marginBottom: 30, marginTop: 25 }}>
            ...
            >
              ...
              <View style={styles.lnamount}>
                <Text
                  style={{ color: Colors.mainTextColor, fontWeight: "bold" }}
                >
                  ₹ {this.state.loanAmountValue}
                </Text>
              </View>
            </View>
            <Slider
              ...
              onSlidingComplete={(value) =>
                this._calculateEMI(value, "loanAmountValue")
              }
              step={1}
            />
            <View
          ...
          <View>
            ...
            <Slider
              ...
              maximumTrackTintColor="#4B0082"
              onSlidingComplete={(value) =>
                this._calculateEMI(value, "tenureValue")
              }
              step={1}
            />
            <View
            ...
            >
              <Text style={{ marginLeft: 15 }}>
                {this.state.minTenure} Years
              </Text>
              <Text style={{ marginRight: 15 }}>
                {this.state.maxTenure} Years
              </Text>
            </View>
            <View></View>
          </View>
          ...
          <View style={{ flexDirection: "row", marginLeft: 15, marginTop: 20 }}>
            <Text
              style={{ fontSize: 30, fontWeight: "bold", color: "#3CB371" }}
            >
              {" "}
              ₹ {this.state.emiamnt} / -{" "}
            </Text>
          ...
          <View>
            <Text style={{ marginTop: 20, marginLeft: 15, marginBottom: 10 }}>
              Interest Rate
            </Text>
            <View>
              <View
                style={{
                  marginLeft: 15,
                  borderWidth: this.state.checked ? 1 : 0,
                  width: 52,
                  borderRadius: 5,
              ...
              >
                {this.state.checked && (
                  <View style={{ width: 40, height: 20 }}>
                    <TextInput
                      ...
                      onChangeText={(val) =>
                        this.state.checked &&
                        this.setState({ interestRateValue: val }, () =>
                          this._doCalculateEMI()
                        )
                      }
                    />
                ...
                <View style={{ marginTop: -20, marginLeft: 38, width: 10 }}>
                  <Text style={{ color: Colors.mainTextColor }}>%</Text>
                </View>
              </View>
              {this.state.checked && (
              ...
              <View style={{ backgroundColor: "#000000aa", flex: 1 }}>
                ...
                >
                  ...
                  >
                    ...
                    >
                      ₹ {this.state.total_amount_payable}
                    </Text>
                  </View>
                </View>
              </View>
