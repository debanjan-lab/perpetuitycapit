...
class ApplyScreen1 extends Component{
    ...
    render(){
        return(
            ...
            <Text style={{color:Colors.mainTextColor,fontSize:12}}>Your PAN Card help us in verifying your details</Text>
            </View>
            ...
            <Text style={{marginLeft:8,color:Colors.mainTextColor}}>PAN number</Text>
            </View>
            ...
            <TouchableOpacity onPress={() => this.props.navigation.navigate('ApplyScreen2')}>
