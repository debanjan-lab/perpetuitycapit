      ...
      <View style={styles.container}>
        ...
        <ScrollView contentContainerStyle={{ flexGrow: 1, paddingBottom: 20 }}>
          ...
          <DashboardCard>
            <Card
              name="Name"
              plcholder="Enter your name"
              props={this.props}
              onChangeText={(v) => this.onChangeHandler("Name", v)}
            >
            ...
            <View style={{ padding: 10, marginBottom: 10 }}>
              ...
              <View style={{ flexDirection: "row", paddingLeft: 25 }}>
                <TextInput
                  ...
                  style={[
                    styles.txtinput,
                    { width: 38, marginRight: 15, color: "black" },
                  ]}
                />
                <TextInput
                  placeholder="mm"
            ...
            <Card
              ...
              props={this.props}
              onChangeText={(v) => this.onChangeHandler("adhaar", v)}
            >
          ...
          >
            <TouchableOpacity
              onPress={() => this.props.navigation.navigate("ApplyScreen3")}
            >
